...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2023 at 05:45 PM
...
(2, 'Keyra', '089765345788', 'Pidada'),
(3, 'Reyna', '081234678967', 'Denpasar'),
(4, 'Ridho', '086789654324', 'Pidada');
...
CREATE TABLE `transaksi` (
  ...
  `transaksi_tgl_selesai` text NOT NULL,
...
(2, '2023-06-22', 3, 21000, 3, '2023-06-24', 0),
(3, '2023-06-22', 4, 7000, 1, '2023-06-25', 1),
(4, '2023-06-22', 3, 14000, 2, '2023-06-20', 2);
...
--
ALTER TABLE `pakaian`
  MODIFY `pakaian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
